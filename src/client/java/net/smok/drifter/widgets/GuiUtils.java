...
public class GuiUtils {
     ...
     * @param bufferBuilder Preload BufferBuilder. Doesn't close in this method
    ...
    public static void drawCircle(BufferBuilder bufferBuilder, double x, double y, double radius, int sides, int color) {
        drawCircle(bufferBuilder, x, y, radius, sides, color, 0.5);
    }

    /**
     * Draw circle
     * @param bufferBuilder Preloaded BufferBuilder. Doesn't close in this method
     * @param x Center X position on screen
     * @param y Center Y position on screen
     * @param radius Radius of circle in pixels
     ...
     * @param bufferBuilder preload BuffBuilder. Doesn't close in this method
     * @param x Center X position on screen
     * @param y Center Y position on screen
     * @param radius Radius of circle in pixels
     * @param sides Amount of sides. More side more smooth
     ...
     */
    public static void drawSerifArc(BufferBuilder bufferBuilder, double x, double y, double radius, int sides,
                                    int mainColor, int secondColor, double start, double end, double amount) {
        drawArc(bufferBuilder, x, y, radius, sides, mainColor, secondColor, start, end, amount, 0.5, 0.05, 4);
    }
     ...
     */
    public static void drawArc(BufferBuilder bufferBuilder, double x, double y, double radius, int sides, int mainColor,
     ...
     * @param amount Main color segment size. Between 0 and 1 - from start to end segment
     */
    public static void drawArc(BufferBuilder bufferBuilder, double x, double y, double radius, int sides, int mainColor, int secondColor, double start, double end, double amount) {
        drawSerifArc(bufferBuilder, x, y, radius, sides, mainColor, secondColor, start, end, amount, 0.5);
    }
     ...
     * @param arcThickness Arc line thickness in half of pixels, i.e. 0.5 = 1px
     */
    public static void drawSerifArc(BufferBuilder bufferBuilder, double x, double y, double radius, int sides, int mainColor, int secondColor, double start, double end, double amount, double arcThickness) {
